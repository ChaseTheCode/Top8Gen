...
# bg size 1920 x 1080
bg = Image.open('resources/events/USW/background.png')
fg = Image.open('resources/events/USW/numbers.png')
cboxes = Image.open('resources/events/USW/playerboxes.png')
nameplates = Image.open('resources/events/USW/nameplates.png')
sponsor_big = Image.open('resources/events/USW/sponsor_big.png')
...
fnt = ImageFont.truetype('resources/events/USW/font.ttf', 1)
...
# open if
first_secondary_1 = Image.open('resources/characters/SSBU/icons/mario_00.png')
first_portrait.paste(first_secondary_1, (528, 8), first_secondary_1)
# close if

# open if
first_secondary_2 = Image.open('resources/characters/SSBU/icons/mario_00.png')
first_portrait.paste(first_secondary_2, (456, 8), first_secondary_1)
# close if


# open if sponsor
fnt = ImageFont.truetype('resources/events/USW/font.ttf', 25)
...
second_portrait = Image.open('resources/characters/SSBU/portraits/steve_07.png')

second_portrait = second_portrait.resize((322, 348), Image.Resampling.LANCZOS)

# open if secondary 1
second_secondary_1 = Image.open('resources/characters/SSBU/icons/mario_01.png')
...
# open if secondary 2
second_secondary_2 = Image.open('resources/characters/SSBU/icons/mario_01.png')
...
# open if sponsor
fnt = ImageFont.truetype('resources/events/USW/font.ttf', 20)
...
fnt = ImageFont.truetype('resources/events/USW/font.ttf', 30)
namebox2 = Image.new('RGBA', (nboxW, nboxH))
namebox2 = create_namebox(namebox2, fnt, "hhhhhhhhhhhhhhhh".upper())

# third

third_portrait = Image.open('resources/characters/SSBU/portraits/steve_07.png')

third_portrait = third_portrait.resize((322, 348), Image.Resampling.LANCZOS)

third_secondary_1 = Image.open('resources/characters/SSBU/icons/mario_01.png')
...
third_secondary_2 = Image.open('resources/characters/SSBU/icons/mario_01.png')
...
fourth_portrait = Image.open('resources/characters/SSBU/portraits/steve_07.png')

fourth_portrait = fourth_portrait.resize((322, 348), Image.Resampling.LANCZOS)

fourth_secondary_1 = Image.open('resources/characters/SSBU/icons/mario_01.png')
...
fourth_secondary_2 = Image.open('resources/characters/SSBU/icons/mario_01.png')
...
fifth_portrait = Image.open('resources/characters/SSBU/portraits/lucina_03.png')

fifth_portrait = fifth_portrait.resize((238, 257), Image.Resampling.LANCZOS)

fifth_secondary_1 = Image.open('resources/characters/SSBU/icons/mario_02.png')
...
fifth_secondary_2 = Image.open('resources/characters/SSBU/icons/mario_02.png')
...
fnt = ImageFont.truetype('resources/events/USW/font.ttf', 21)
...
sixth_portrait = Image.open('resources/characters/SSBU/portraits/lucina_03.png')

sixth_portrait = sixth_portrait.resize((238, 257), Image.Resampling.LANCZOS)

sixth_secondary_1 = Image.open('resources/characters/SSBU/icons/mario_02.png')
...
sixth_secondary_2 = Image.open('resources/characters/SSBU/icons/mario_02.png')
...
seventh_portrait = Image.open('resources/characters/SSBU/portraits/lucina_03.png')

seventh_portrait = seventh_portrait.resize((238, 257), Image.Resampling.LANCZOS)

seventh_secondary_1 = Image.open('resources/characters/SSBU/icons/mario_02.png')
...
seventh_secondary_2 = Image.open('resources/characters/SSBU/icons/mario_02.png')
...
eighth_portrait = Image.open('resources/characters/SSBU/portraits/lucina_03.png')

eighth_portrait = eighth_portrait.resize((238, 257), Image.Resampling.LANCZOS)

eighth_secondary_1 = Image.open('resources/characters/SSBU/icons/mario_00.png')
...
eighth_secondary_2 = Image.open('resources/characters/SSBU/icons/mario_02.png')
...
fnt = ImageFont.truetype('resources/events/USW/font.ttf', 33)
...
namebox_slug = create_namebox(namebox_slug, fnt, "start.gg/usw129".upper())

fnt = ImageFont.truetype('resources/events/USW/font.ttf', 43)
...
fnt = ImageFont.truetype('resources/events/USW/font.ttf', 35)
